    ...
    if (node1 !== undefined && node1.kind !== undefined) {
        ...
        if (!node2.isUnderscore) {
            if (node1.kind !== node2.kind) {
                array.push({ name: node1.kind, lineNumber: node1.lineNumber, startPosition: node1.startPosition, endPosition: node1.endPosition, message: `Unexpected kind. Expected ${node2.kind}` });
            }
            else {
                switch (node1.kind) {
    ...
    for (let element in savedValue) {
        if (savedValue[element].dollarValue === rightValue.name) {
            ...
            if (savedValue[element].correspondent !== userValue.name) {
                array.push({ name: userValue.name, lineNumber: userValue.lineNumber, startPosition: userValue.startPosition, endPosition: userValue.endPosition, message: `The value '${userValue.name}' is not the expected one` })
            }
        }
    }
    if (!value) {
...
function visitFunctionDefinition(node1, node2, savedValue, array) {
    if (!node2.isUnderscore) {
        if (checkIfDollar(node2)) {
            ...
            array.push({ name: node1.name, lineNumber: node1.lineNumber, startPosition: node1.startPosition, endPosition: node1.endPosition, message: "Wrong function name" })
        }
    }
...
function visitPattern(node1, node2, savedValue, array) {
    if (!node2.isUnderscore) {
        if (checkIfDollar(node2)) {
            checkDollarValues(node1, node2, array, savedValue);
        } else if (node1.functionName !== node2.functionName) {
            array.push({ name: node1.functionName, lineNumber: node1.lineNumber, startPosition: node1.startPosition, endPosition: node1.endPosition, message: `The name of the function is not correct` })
        }
    }
...
function visitListPattern(node1, node2, savedValue, array) {
    if (!node2.left.isUnderscore) {
        if (checkIfDollar(node2.left)) {
            ...
            array.push({ name: node1.left.name, lineNumber: node1.left.lineNumber, startPosition: node1.left.startPosition, endPosition: node1.left.endPosition, message: `Unexpected left argument for list'` })
        }
    }
    ...
    if (!node2.right.isUnderscore) {
        if (checkIfDollar(node2.right)) {
            ...
            array.push({ name: node1.right.name, lineNumber: node1.right.lineNumber, startPosition: node1.right.startPosition, endPosition: node1.right.endPosition, message: `Unexpected right argument for list'` })
        }
...
function visitFunctionName(node1, node2, savedValue, array) {
    if (!node2.isUnderscore) {
        if (checkIfDollar(node2)) {
            ...
            array.push({ name: node1.name, lineNumber: node1.lineNumber, startPosition: node1.startPosition, endPosition: node1.endPosition, message: `Unexpected function name '${node1.name}'` })
        }
