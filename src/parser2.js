...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c42 = function() { return { id: randomId(), kind: "functionApplication", lineNumber: location().start.line, startPosition: location().start.column,
            endPosition: location().end.column, isUnderscore: true } },
        peg$c43 = function(left, f, right) { return { id: randomId(), kind: "functionApplication", lineNumber: location().start.line, startPosition: location().start.column, endPosition: location().end.column, functionName: f, arguments: [left, right]}},
        peg$c44 = function(exp1, list) { list.unshift(exp1); return list; },
        peg$c45 = function(exp) { return exp; },
        peg$c46 = function(list) { return { id: randomId(), kind: "list", lineNumber: location().start.line, startPosition: location().start.column, endPosition: location().end.column, items: list || [] }; },
        peg$c47 = function() { return { kind: "list", isUnderscore: true } },
        peg$c48 = ",",
        ...
        peg$c67 = function(digits) { return { id: randomId(),  kind: "int", lineNumber: location().start.line, startPosition: location().start.column,
            endPosition: location().end.column, value: parseInt(digits.join(""), 10)} ; },
        peg$c68 = function() { return { id: randomId(), kind: "int", isUnderscore: true } },
        peg$c69 = "False",
        peg$c70 = peg$literalExpectation("False", false),
        peg$c71 = function() { return { id: randomId(),  kind: "bool", lineNumber: location().start.line, startPosition: location().start.column,
            endPosition: location().end.column, value: 'False' }},
        peg$c72 = "True",
        peg$c73 = peg$literalExpectation("True", false),
        peg$c74 = function() { return { id: randomId(),  kind: "bool", lineNumber: location().start.line, startPosition: location().start.column,
